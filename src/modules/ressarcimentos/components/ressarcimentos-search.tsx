...
export function RessarcimentosSearch({ clientes }: Props) {
  ...
  function updateParams(updates: Record<string, string | null>) {
    ...
    startTransition(() => router.replace(`/ressarcimentos?${next.toString()}`));
  }
    ...
    <div className="space-y-3 rounded-md border bg-card p-4">
        ...
        <div>
          ...
          <Select value={status} onValueChange={(v) => updateParams({ status: v, page: "1" })}>
            ...
            <SelectContent>
              ...
              {Object.entries(STATUS_RESSARCIMENTO_LABELS).map(([k, v]) => (
      ...
      <div>
        ...
        <div className="relative">
          ...
          <Input
            placeholder="Descrição, nome do cliente ou CNJ..."
            value={search}
