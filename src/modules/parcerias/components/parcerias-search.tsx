...
import { STATUS_PARCERIA_LABELS } from "../schema";
...
export function ParceriasSearch({ clientes, parceiros }: Props) {
  ...
  function updateParams(updates: Record<string, string | null>) {
    ...
    startTransition(() => router.replace(`/parcerias?${next.toString()}`));
  }
        ...
        <div>
          ...
          <Select value={status} onValueChange={(v) => updateParams({ status: v, page: "1" })}>
            ...
            <SelectContent>
              ...
              {Object.entries(STATUS_PARCERIA_LABELS).map(([k, v]) => (
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <div className="sm:col-span-2">
          ...
          <div className="relative">
            ...
            <Input
              placeholder="Parceiro, cliente, CNJ ou observação..."
              value={search}
